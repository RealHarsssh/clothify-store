...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Login to Cloth Buster</h2>
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-lg border w-full max-w-sm">
        <input
  type="email"
  placeholder="Email"
  className="w-full mb-4 px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-200 text-gray-800 placeholder-gray-400-full mb-4 px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-200 text-gray-800 placeholder-gray-400"
  value={email}
